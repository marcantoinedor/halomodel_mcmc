...
for p in ps:
    ...
    plt.savefig('figures/corrFunction/p={0}/xip_CFHT.png' .format(p), bbox_inches='tight')
    plt.clf()
    ...
    plt.savefig('figures/corrFunction/p={0}/xim_CFHT.png' .format(p), bbox_inches='tight')
    plt.clf()
    print("p={0}" .format(p))
# plt.show()
