...
for p in ps:
    ...
    os.system('mkdir -p figures/correlation/p={0}' .format(p))
    ...
    if CFHT_data:
        ...
        plt.savefig('figures/correlation/p={0}/xip_CFHT.png' .format(p), dpi=200, bbox_inches='tight')
    else:
        plt.savefig('figures/correlation/p={0}/xip.png' .format(p), dpi=200, bbox_inches='tight')
    plt.clf()
    ...
    if CFHT_data:
        ...
        plt.savefig('figures/correlation/p={0}/xim_CFHT.png' .format(p), dpi=200, bbox_inches='tight')
    else:
        plt.savefig('figures/correlation/p={0}/xim.png' .format(p), dpi=200, bbox_inches='tight')
    plt.clf()
