...
for index_a in range(1, len(a_s)+1):
    ...
    for p in ps:
        ...
        os.system('mkdir -p figures/mass/a={1}/p={0}' .format(*[p, a]))
        ...
        for q in qs:
            ...
            i += 1
        plt.title("Mass function varying $q$, $p=${0}, $a=${1}" .format(*[p, a]))
        plt.legend()
        plt.savefig('figures/mass/a={1}/p={0}/mass_q.png' .format(*[p, a]), bbox_inches='tight')
        plt.clf()
    print("a=" + str(a))
# plt.show()
