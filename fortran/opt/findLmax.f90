PROGRAM halo_model
   ...
   IMPLICIT NONE
   REAL ::power_f, mass, l_length_real, kmin, kmax, amin, amax, lmin, lmax, na_real, l_max_real, thmin, thmax
   ...
   CHARACTER(len=256) :: fbase, fbase2, fext, output, l_length_str, l_max_str, output1, output3
   TYPE(halomod) :: hmod
   TYPE(cosmology) :: cosm
   LOGICAL :: verbose2
   REAL :: coucou
   ...
   ! In lensing, we consider redshift between 0 and 3,5
   amin = 0.22
   amax = 1.0
   na = 10
